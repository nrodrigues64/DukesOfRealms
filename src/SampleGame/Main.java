...
public class Main extends Application {
	...
	private Chateau chatplayer;
	private List<Enemy> enemies = new ArrayList<>();
	private List<Missile> missiles = new ArrayList<>();
	private ArrayList[][] map = new ArrayList[10][10];
	...
	private void loadGame() {
		castle = new Image(getClass().getResource("/images/redcastle.png").toExternalForm(), 100, 100, true, true);
		...
		//castle = new Image(getClass().getResource("/images/grey_castle.png").toExternalForm(), 100, 100, true, true);
	...
	private void createPlayer() {
		double x = 0;
		double y = 700;
		player = new Player(playfieldLayer, castle, x, y, Settings.PLAYER_HEALTH, Settings.PLAYER_DAMAGE,
	...
	public static int[] calculCoordonne(int x, int y){
		int coor[] = new int[2];
		coor[0] = (int)(Settings.SCENE_HEIGHT/10);
		coor[1] = (int)(Settings.SCENE_WIDTH/10);
		return coor;
